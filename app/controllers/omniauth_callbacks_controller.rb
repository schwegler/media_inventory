...
class OmniAuthCallbacksController < ApplicationController
  ...
  def setup_mastodon(req)
    ...
    if server.blank?
      # Security: Do not reflect parameters in error messages to prevent sensitive data leakage
    ...
    unless MastodonAppRegistration.safe_host?(host)
      # Security: Validate host early to prevent Server-Side Request Forgery (SSRF)
