...
RSpec.describe 'Video Games Management', type: :system do
  ...
  it 'enables me to create, edit, and delete a video game',
     pending: 'Flaky test in CI due to Capybara click interception' do
    # Log in
    visit login_path
    ...
    submit_form_button 'Create Video Game'
    ...
    submit_form_button 'Save Review & Playing Status'
