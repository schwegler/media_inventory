...
RSpec.describe InventoryController, type: :controller do # rubocop:disable Metrics/BlockLength
  let(:dummy_model) do
    Class.new do
  ...
  describe 'controller actions via ComicsController' do # rubocop:disable Metrics/BlockLength
